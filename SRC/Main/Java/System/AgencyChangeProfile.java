...
@WebServlet("/agency-change-profile")
@MultipartConfig(
    fileSizeThreshold = 1024 * 1024,
    maxFileSize = 5 * 1024 * 1024,
    maxRequestSize = 10 * 1024 * 1024
)
public class AgencyChangeProfile extends HttpServlet {
    protected static String UPLOADDIR = "Assets/Profile/Agency";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
        ...
        String newFileName = "Agency-" + System.currentTimeMillis() + extension;
        ...
        try (Connection connect = DBConnection.getConnection()) {
            ...
            response.sendRedirect("agency-profile");
