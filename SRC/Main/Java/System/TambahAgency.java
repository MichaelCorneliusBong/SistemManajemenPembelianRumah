...
@WebServlet("/tambah-agency")
public class TambahAgency extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
        ...
        try {
            ...
            request.getRequestDispatcher("TambahAgency.jsp").forward(request, response);
            return;
        }
        ...
        try (Connection conn = DBConnection.getConnection()) {
            ...
            String sql = "INSERT INTO users(name, phone, email, password, role) VALUES (?, ?, ?, ?, 'AGENCY')";
