...
<script>
    ...
    function profile() { window.location.href = "admin-profile"; }

    function home() { window.location.href = "home-admin"; }
    
    function desainrumah() { window.location.href = "desain-rumah-admin"; }

    function tambahagency() { window.location.href = "tambah-agency"; }
